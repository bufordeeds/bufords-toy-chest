      ...
      <div className="container">
        <section className="hero-section">
          ...
          <p className="hero-subtitle">
            Help shape the future of Buford's Toy Chest by voting for the games you want to play!
          </p>
        </section>
        ...
        <section className="voting-info">
          <div className="info-card">
            <h2>How It Works</h2>
            <ul>
              <li>Vote for the games you'd like to see added next</li>
              <li>The game with the most votes gets priority development</li>
              <li>You can change your vote anytime</li>
              <li>New games are added regularly based on community feedback</li>
            </ul>
          </div>
          ...
          {leadingGame && leadingVotes > 0 && (
            <div className="leader-card">
              ...
              <div className="leader-info">
                <span className="leader-icon">{leadingGame.icon}</span>
                <div className="leader-details">
                  <span className="leader-name">{leadingGame.name}</span>
                  <span className="leader-votes">{leadingVotes} votes</span>
                </div>
              </div>
            </div>
          )}
        ...
        <section className="feedback-section">
          <div className="feedback-card">
            ...
            <p>
              Don't see a game you'd like to play? We'd love to hear your suggestions!
            </p>
            <a 
